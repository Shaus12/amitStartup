...
function potentialColor(p: "high" | "medium" | "low") {
  ...
  return { color: "var(--bv-text-3)", bg: "var(--bv-text-3)12", label: "פוטנציאל נמוך" };
}
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          gap: 10,
          padding: "10px 14px",
          backgroundColor: expanded ? "var(--bv-surface-raised)" : "var(--bv-surface)",
          border: "none",
          cursor: "pointer",
          textAlign: "right",
      ...
      >
        <div style={{ flexShrink: 0, color: "var(--bv-muted)" }}>
      ...
      {/* Expanded sub-steps */}
      {expanded && (
        <div style={{ backgroundColor: "var(--bv-bg)", padding: "12px 14px 14px" }}>
          {loading && (
            <div style={{ display: "flex", alignItems: "center", gap: 8, color: "var(--bv-text-3)" }}>
                ...
                {breakdown.subSteps.map((step, i) => (
                  <div
                    ...
                    style={{
                      ...
                      border: `1px solid ${step.automatable ? "rgba(77,142,255,0.15)" : "var(--bv-border)"}`,
                    }}
                  >
                    {/* Step number */}
                    <div
                      style={{
                        ...
                        height: 20,
                        borderRadius: "50%",
                        backgroundColor: step.automatable ? "rgba(77,142,255,0.15)" : "var(--bv-border)",
                        color: step.automatable ? "#4d8eff" : "var(--bv-muted)",
                        fontSize: 9,
                        fontWeight: 800,
                        display: "flex",
                        alignItems: "center",
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 2 }}>
                        ...
                        <span
                          style={{
                            ...
                            padding: "1px 6px",
                            borderRadius: 99,
                            backgroundColor: step.automatable ? "rgba(77,142,255,0.12)" : "var(--bv-border)",
                            color: step.automatable ? "#4d8eff" : "var(--bv-muted)",
                            border: `1px solid ${step.automatable ? "rgba(77,142,255,0.25)" : "var(--bv-border)"}`,
                            fontFamily: "var(--font-inter)",
                            whiteSpace: "nowrap",
                            flexShrink: 0,
                          }}
  ...
  if (departments.length === 0) {
    return (
      ...
      >
        ...
        <div style={{ fontSize: 14, color: "var(--bv-muted)", fontFamily: "var(--font-manrope)", fontWeight: 700 }}>
          אין מחלקות עדיין
        </div>
            ...
            return (
              <div key={dept.id}>
                ...
                {dept.processes.length === 0 ? (
                  <p style={{ fontSize: 12, color: "var(--bv-border-subtle)", fontFamily: "var(--font-inter)", fontStyle: "italic" }}>
                    אין תהליכים רשומים
                  </p>
                ) : (
