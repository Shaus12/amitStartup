  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-sm mx-4">
        <Link href="/" className="flex items-center justify-center gap-2 mb-8 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2 focus:ring-offset-[#0b0c11]">
          <Image src="/logo.png" alt="BizMap Logo" width={40} height={40} className="w-10 h-10 object-contain" priority />
