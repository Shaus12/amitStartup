...
const faqItems = [
  ...
  {
    q: "מה זה '14 יום במערכת: המוח השני של העסק'?",
    a: "אחרי שתקבלו את הניתוח, תוכלו לגשת למערכת הצ׳אט החכמה שלנו למשך 14 יום ולשאול שאלות ספציפיות על העסק שלכם — AI שכבר מכיר את הפרטים שלכם.",
  },
  {
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            {[
              ...
              },
              {
                ...
                value: "(שווי אמיתי: 14 יום ליווי AI אישי — 990₪+מע״מ)",
              },
            ].map((bonus, i) => (
              <div
                key={i}
          ...
          <div className="flex flex-col gap-8">
            {[
              ...
              },
              {
                ...
                desc: "ה-14 יום האחרים הם של השאלות: שולחים שאלות, מקבלים תשובות שמבוססות על הנתונים הספציפיים שלכם. AI שכבר מכיר את העסק — וזמין תמיד.",
              },
            ].map((item, i) => (
              <div
                key={i}
