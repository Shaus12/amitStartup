...
function FAQSection() {
  ...
  const items = [
    ...
    { q: "למה לשלם 49 ₪ אם אני יכול לנסות לעשות את זה לבד?", a: "אפשר לנסות \u2014 אבל זה בדיוק מה שרוב בעלי העסקים עושים כבר חודשים, ועדיין מנחשים. 49 ₪ חד-פעמי זה פחות ממה שיועץ גובה על שעה אחת, בשביל מפה מלאה של העסק וצעד ראשון מדויק. ומספיק שתובנה אחת תחסוך כמה אלפי שקלים \u2014 וזה כבר החזיר את עצמו פי כמה." },
      ...
      <div className="max-w-[1000px] mx-auto">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 mt-8 relative z-10 flex-wrap">
            {["49₪ חד-פעמי", "אחריות 100% החזר כספי", "30 מקומות בלבד"].map((t) => (
