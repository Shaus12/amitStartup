...
function BonusesSection() {
  const bonuses = [
    ...
    {
      emoji: "4",
      title: "14 יום נוספים במערכת: המוח השני של העסק",
      body: "14 יום נוספים, חינם לגמרי, עם המוח השני של העסק \u2014 צ\u2019אט שמאומן עליכם ועל הידע שלכם, שיודע לעקוב אחרי פרויקטים של הטמעת AI ולפרק כל מטרה למשימות. לא ChatGPT שמתחיל מאפס בכל שיחה \u2014 יועץ שכבר מכיר את העסק שלכם.",
      value: "990",
      valueLabel: "14 יום ליווי AI אישי",
      color: C.green,
        ...
        <div className="mt-14 bv-reveal">
          ...
          >
            ...
            <p className="text-base leading-relaxed font-medium" style={{ ...IF, color: C.sub }}>
              {"החלטנו לצאת בהשקה אמיתית: לפתוח אותה ל-30 בעלי העסקים הראשונים במחיר הזה, לשבת על הפידבקים, ולשפר. זה הרגע היחיד שבו אפשר להיכנס לדבר הזה במחיר כזה."}
            </p>
            <p className="text-sm font-bold mt-3" style={{ ...IF, color: C.amber }}>
              {"לא טיימר מזויף. החלטה עסקית אמיתית. ברגע שנסגור את ה-30 הראשונים \u2014 המחיר הזה נעלם."}
            </p>
          </div>
        </div>
      </div>
